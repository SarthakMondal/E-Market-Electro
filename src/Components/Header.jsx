        ...
        <div>
            ...
            <nav id="navbar">
                ...
                <ul className="d-flex flex-column align-items-center">
                    ...
                    <li><NavLink to="/signup" onClick={() => toggleMenu(false)}><FontAwesomeIcon icon={faUserPlus} /> Signup  User</NavLink></li>
                    <li><NavLink to="/login" onClick={() => toggleMenu(false)}><FontAwesomeIcon icon={faRightFromBracket} /> Login Portal</NavLink></li>
